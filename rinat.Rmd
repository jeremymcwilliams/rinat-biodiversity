...
```{r}
sum<-orArachnids2019 %>% group_by(scientific_name) %>% summarize(n=n())
...
#taxons<-orArachnids2019$scientific_name

#diversity(taxons, index="shannon")
